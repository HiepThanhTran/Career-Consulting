...
class JobDescription(models.Model):
    ...
    experience_year = models.CharField(max_length=20, null=True, blank=True)
    number_of_recruits = models.IntegerField(null=True, blank=True)
    work_form = models.CharField(max_length=20, null=True, blank=True, choices=[(work.name, work.value) for work in WorkForm])
    gender = models.CharField(max_length=20, null=True, blank=True, choices=[(gender.name, gender.value) for gender in Gender])
