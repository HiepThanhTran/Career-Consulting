...
urlpatterns = [
    ...
    path('account/reset-password/', views.UserPasswordReset.as_view(), name='reset_password'),
    re_path(r'^password\\-reset/(?P<uidb64>[^/]+)/(?P<token>[^/]+)/\\Z$', views.PasswordSet.as_view(), name='set_password'),
]
